...
##  Write a SQL query to find top n records?
-- Example: finding top 5 records from employee table
select * from employee order by salary desc limit 5;

--- 

##  Write a SQL query to find the count of employees working in department 'Admin'
select count(*) from employee where department = 'Admin';

--- 

##  Write a SQL query to fetch department wise count employees sorted by department count in desc order.
...
##  Write a SQL query to find all employees who have bonus record in bonus table
select * from employee;
select * from bonus;
...
##  Write a SQL query to fetch first_name from employee table in upper case
select upper(first_name) as First_Name from employee;

--- 

## Write a SQL query to get combine name (first name and last name) of employees from employee table
select concat(first_name, ' ' ,last_name) as Name from employee;

--- 

##  Write a SQL query to print details of employee of employee 'Jennifer' and 'James'.
select * from employee where first_name in ('Jennifer', 'James');

--- 

##  Write a SQL query to fetch records of employee whose salary lies between
select first_name, last_name, salary from employee where salary between 100000 and 500000;

--- 

##  Write a SQL query to get records of employe who have joined in Jan 2017
select * from employee;
...
##  Write a SQL query to get the list of employees with the same salary
...
##  Write a SQL query to show all departments along with the number of people working there.
select * from employee;
...
##  Write a SQL query to find employee with highest salary in an organization from employee table.
...
##  write a SQL query to find employees with same salary
...
##  Write a SQL query to find out the overall friend acceptance rate for a given date from user_action table.
...
##  Write a SQL query to determine avg time spent per user per day from user_details and event_session_details
...
##  Write a SQL query to find disctinct first name from full user name from usere_name table
...
## write a sql query to find the names of all salesperson that have order with samsonic from
...
##  write a sql query to find the names of all salesperson that do not have any order with Samsonic from the table: salesperson, customer, orders
...
##  Write a SQL query to find out how many users inserted more than 1000 but less than 2000 images in their presentations from event_log table
